# Q_learning_agent.py - HYPER-POSITIVE REWARD TUNE (with Periodic Save)
...
# --- ReplayBuffer, State Vectorization, QNetwork, and DQNAgent are unchanged ---
class ReplayBuffer:
...
def train(agent: DQNAgent, corpus_path="corpus.txt",
    ...
    for ep in trange(episodes, desc="Train"):
        ...
        # --- PERIODIC SAVE ADDED HERE ---
        # Saves the model every 5000 episodes, allowing for evaluation if training is interrupted.
        if (ep + 1) % 5000 == 0:
